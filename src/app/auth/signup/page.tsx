      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-lg backdrop-blur-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-12 py-3 bg-input border rounded-lg focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent transition-all duration-200 text-foreground placeholder:text-muted-foreground ${
            ...
            <div className="space-y-2">
              <label className="flex items-start space-x-3">
                <input
                  ...
                  className="w-4 h-4 mt-0.5 text-primary bg-input border-border rounded focus:ring-ring focus:ring-2"
                  required
                  disabled={loading}
                />
            ...
            <button
              type="submit"
              disabled={!formData.agreeToTerms || !passwordsMatch || loading}
          ...
          <div className="space-y-3">
            <button 
              ...
              disabled={loading}
              className="w-full bg-secondary text-secondary-foreground py-3 px-4 rounded-lg font-medium hover:bg-secondary/80 transition-all duration-200 flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
